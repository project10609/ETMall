...
class EtmallbrowSpider(scrapy.Spider):
    name = 'etmallbrow'

    start_urls = ['http://www.etmall.com.tw/%E7%9C%89%E7%AD%86-%E7%9C%89%E7%B2%89-%E7%9C%89%E8%86%A0-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47570?page=/']
    ...
    def parse(self, response):
        ...
        next_page = 'http://www.etmall.com.tw/%E7%9C%89%E7%AD%86-%E7%9C%89%E7%B2%89-%E7%9C%89%E8%86%A0-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47570?page=' + str(
            EtmallbrowSpider.page)
        if EtmallbrowSpider.page <= 10:
            # self.action.pause(1)
            # self.action.perform()
            EtmallbrowSpider.page += 1
            url = next_page
