...
class EtmallmascaraSpider(scrapy.Spider):
    name = 'etmallmascara'

    start_urls = ['http://www.etmall.com.tw/%E7%9D%AB%E6%AF%9B%E8%86%8F-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47571?page=/']
    ...
    def parse(self, response):
        ...
        next_page = 'http://www.etmall.com.tw/%E7%9D%AB%E6%AF%9B%E8%86%8F-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47571?page=' + str(
            EtmallmascaraSpider.page)
        if EtmallmascaraSpider.page <= 10:
            # self.action.pause(1)
            # self.action.perform()
            EtmallmascaraSpider.page += 1
            url = next_page
