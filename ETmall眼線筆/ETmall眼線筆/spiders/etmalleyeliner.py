...
class EtmalleyelinerSpider(scrapy.Spider):
    name = 'etmalleyeliner'

    start_urls = ['http://www.etmall.com.tw/%E7%9C%BC%E7%B7%9A%E7%AD%86-%E7%9C%BC%E7%B7%9A%E6%B6%B2-%E7%9C%BC%E7%B7%9A%E8%86%A0-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47568?page=/']
    ...
    def parse(self, response):
        ...
        next_page = 'http://www.etmall.com.tw/%E7%9C%BC%E7%B7%9A%E7%AD%86-%E7%9C%BC%E7%B7%9A%E6%B6%B2-%E7%9C%BC%E7%B7%9A%E8%86%A0-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47568?page=' + str(
            EtmalleyelinerSpider.page)
        if EtmalleyelinerSpider.page <= 10:
            # self.action.pause(1)
            # self.action.perform()
            EtmalleyelinerSpider.page += 1
            url = next_page
