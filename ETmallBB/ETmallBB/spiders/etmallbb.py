...
class EtmallbbSpider(scrapy.Spider):
    name = 'etmallbb'

    start_urls = ['http://www.etmall.com.tw/BB-CC-DD-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47563?page=/']
    ...
    def parse(self, response):
        ...
        next_page = 'http://www.etmall.com.tw/BB-CC-DD-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47563?page=' + str(
            EtmallbbSpider.page)
        if EtmallbbSpider.page <= 10:
            # self.action.pause(1)
            # self.action.perform()
            EtmallbbSpider.page += 1
            url = next_page
