...
class EtmallblushSpider(scrapy.Spider):
    name = 'etmallblush'

    start_urls = ['http://www.etmall.com.tw/%E8%85%AE%E7%B4%85-%E4%BF%AE%E5%AE%B9-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47573?page=/']
    ...
    def parse(self, response):
        ...
        next_page = 'http://www.etmall.com.tw/%E8%85%AE%E7%B4%85-%E4%BF%AE%E5%AE%B9-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47573?page=' + str(EtmallblushSpider.page)
        if EtmallblushSpider.page <= 10:
            # self.action.pause(1)
            # self.action.perform()
            EtmallblushSpider.page += 1
            url = next_page
