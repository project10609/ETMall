...
class EtmalllipstickSpider(scrapy.Spider):
    name = 'etmalllipstick'
    start_urls = ['http://www.etmall.com.tw/%E5%8F%A3%E7%B4%85-%E5%94%87%E9%87%89-%E5%94%87%E8%9C%9C-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47574?page=']
    ...
    def parse(self, response):
        ...
        next_page = 'http://www.etmall.com.tw/%E5%8F%A3%E7%B4%85-%E5%94%87%E9%87%89-%E5%94%87%E8%9C%9C-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/47574?page=' + str(EtmalllipstickSpider.page)
        if EtmalllipstickSpider.page <= 10:
            # self.action.pause(1)
            # self.action.perform()
            EtmalllipstickSpider.page += 1
            url = next_page
