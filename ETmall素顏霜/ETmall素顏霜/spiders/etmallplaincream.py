...
class EtmallplaincreamSpider(scrapy.Spider):
    name = 'etmallplaincream'

    start_urls = ['http://www.etmall.com.tw/%E7%B4%A0%E9%A1%8F%E9%9C%9C-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/99296?page=/']
    ...
    def parse(self, response):
        ...
        for items in soup.find('ul', {'class': 'n-hover--img n-m-bottom--sm n-card__list fun-searchResult-list'}).find_all_next('div',{'class':'n-card__box'}):
            ...
            item['product_subcategory'] = 'otherfoundation'

            yield item

        next_page = 'http://www.etmall.com.tw/%E7%B4%A0%E9%A1%8F%E9%9C%9C-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/99296?page=' + str(EtmallplaincreamSpider.page)
        if EtmallplaincreamSpider.page <= 10:
            # self.action.pause(1)
            # self.action.perform()
            EtmallplaincreamSpider.page += 1
            url = next_page
