...
class EtmalleyeandlipremoverSpider(scrapy.Spider):
    name = 'etmalleyeandlipremover'

    start_urls = ['http://www.etmall.com.tw/%E7%9C%BC%E5%94%87%E5%8D%B8%E5%A6%9D%E6%B6%B2-%E4%B9%B3-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/84043?page=/']
    ...
    def parse(self, response):
        ...
        next_page = 'http://www.etmall.com.tw/%E7%9C%BC%E5%94%87%E5%8D%B8%E5%A6%9D%E6%B6%B2-%E4%B9%B3-%E5%BD%A9%E5%A6%9D%E9%A1%9E%E5%9E%8B/c3/84043?page=' + str(
            EtmalleyeandlipremoverSpider.page)
        if EtmalleyeandlipremoverSpider.page <= 10:
            # self.action.pause(1)
            # self.action.perform()
            EtmalleyeandlipremoverSpider.page += 1
            url = next_page
